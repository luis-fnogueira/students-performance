...
First looking at the grades (which are the quantitative variables) one can see that the grades are relatively similiar among them. There is no big difference when we look at the quartiles and medians.
